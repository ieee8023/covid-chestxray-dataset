...
[Brixia score for 192 images](https://github.com/BrixIA/Brixia-score-COVID-19) (license: CC BY-NC-SA) from the paper [End-to-end learning for the semiquantitative rating of COVID-19 severity on Chest X-rays](https://arxiv.org/abs/2006.04603)
...
*Formats:* For chest X-ray DCM, jpg, or png are preferred. For CT nifti (in gzip format) is preferred but also dcms. Please contact me with any questions.
...
Each image has a license specified in the metadata.csv file. Including Apache 2.0, CC BY-NC-SA 4.0, CC BY 4.0.
